              ...
              >
                <div className="relative aspect-[3/4] overflow-hidden">
                  ...
                  <button onClick={(e) => { e.stopPropagation(); toggleLike(product.id); }}
                    className="absolute top-2.5 right-2.5 z-10 w-8 h-8 bg-white/80 rounded-full flex items-center justify-center transition-all hover:bg-white hover:scale-110 shadow-sm">
